// ページ側スクリプトが依存しているが未定義な関数のダミー定義
window.checkInitialTicketCount = window.checkInitialTicketCount || function() {
  console.warn("⚠️ checkInitialTicketCount はダミー定義です");
};


// ✅ スクリプト読み込み確認用ログ
console.log("✅ funreserv.js 読み込み完了");
